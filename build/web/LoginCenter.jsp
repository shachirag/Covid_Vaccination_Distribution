...
<html lang="en">
    <head>
        ...
        <script>
            ...
            {
               var vcid= document.getElementById("center_id").value;
                ...
                else
                {
                    ...
                    xhttp.onreadystatechange = function ()
                    {
                        ...
                        if (this.readyState == 4 && this.status == 200)
                        {
                            ...
                            {
                               window.open("CenterHome.jsp","_self");
                    ...
                    xhttp.open("GET", "./CenterLoginResponse?vcid="+vcid+"&password="+password, true);
                    xhttp.send();
                }
            }
    ...
    <body>
        ...
        <div style="height: 500px;">
            <h1 class="text-center jumbotron  "  style="background:#FF4F5B" id="heading">Center Login</h1>
            <div >
                <div class="row">
                    <div class="col-4">
                    </div>
                    <div class="col-4">
                        <div>
                            <form>
                                <input type="text" class="form-control" placeholder="Enter Center-ID" id="center_id" />
                                <br>
