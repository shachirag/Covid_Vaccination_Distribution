...
<html lang="en">
    <head>
        ...
        <script>
           ...
           function deletecenterfunction(vcid)
           {
               if(confirm("Are Sure You Want to Delete !!"))
               {
                    ...
                    xhttp.open("GET", "./DeleteCenterResponse?vcid=" + vcid, false);
                ...
                } else
                {
                    ...
                    xhttp.onreadystatechange = function ()
                    {
                        ...
                        if (this.readyState == 4 && this.status == 200)
                        {
                            ...
                            ans = ans + "<tr><th>Name</th><th>Address</th><th>Email</th><th>Phone</th><th>Delete Center</th></tr>";
                            for (var i = 0; i < arr.length; i++)
                            {
                                ans=ans+"<tr>"
                                 ...
                                 ans = ans + "<td><input type='button' value='Delete' class=' btn-block btn-info'  style='height:40px;width:100px;font-size:12px;  background-color: #FF4F5B;border-radius: 5rem;'  onclick='deletecenterfunction("+ arr[i]["vcid"]+ " )' /></td>";
                                 ans = ans + "</tr>";
                            }
                            ans = ans + "</table>";
    ...
    <body>
        ...
        <h1 class="text-center jumbotron  "  style="background:#FF4F5B" id="heading">Search Center By Cities</h1>
        <div class="container">
            <div class="row">
