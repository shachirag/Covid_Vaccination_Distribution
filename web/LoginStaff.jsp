...
<html lang="en">
               ...
               if( password == "" || staff_id== "" )
                ...
                else
                {
                    ...
                    document.getElementById("div1").innerHTML = "Check Your Password Please";
                            ...
                            {
                               window.open("StaffHome.jsp","_self");
                    ...
                    xhttp.open("GET", "./StaffLoginResponse?staff_id="+staff_id+"&password="+password, true);
                    xhttp.send();
                }
            }
    ...
    <body>
        ...
        <div style="height: 500px;">
            <h1 class="text-center jumbotron  "  style="background:#FF4F5B" id="heading">Staff Login</h1>
            <div >
                <div class="row">
                    <div class="col-4">
                    </div>
                    <div class="col-4">
                        <div>
                            <form>
                                <input type="number" class="form-control" placeholder="Enter Staff Id" id="staff_id" />
                                <br>
